...
#mutate(Q4 = as.integer(Q4))
#am having trouble with including as because when I do as.integer() it makes all the values NA.
#making graph of means for 5 axes
#putting in an image
...
female %>%
  ...
  ggplot(aes(x = Q4)) + geom_histogram()

mean_ci(updf$Depression)
kable()
...
# Q7 1 is for fun, 2 is for trying to pursue professionally, 3 is make a living,
# 4 is mixed

updf %>%
  count(Q8)
#probably want hobbyists,
