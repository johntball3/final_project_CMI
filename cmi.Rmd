...
## hypomania histograms, then moved over to creating all histograms in shiny app. Did the
## same for mean and standard deviation. Also commented interactive model code
## for alcoholism analysis.
